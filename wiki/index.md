...
| [Domain name shortlist](syntheses/strategy/2026-09-13_domain-name-shortlist.md) | Recommended `fixouch.com` (alternates `sameouch.com`, `ouchdex.com`; French pass kept `cacoince.fr`), 430 names DNS-checked, 2026 prices, buy steps |
