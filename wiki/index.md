...
| Page | Summary |
|---|---|
| [Entity pages vs the Maker space (panel)](syntheses/strategy/2026-09-12_entity-pages-vs-maker-space.md) | Panel decision: the entity page is the complete, free, public listing (top 3 open, rest folded, never paywalled); the Terminal is where intent data (opt-in access, trends, export, alerts) is sold after the Cercle 2 signal; entity pages are created editorially, never claimed or auto-created; private `entity_candidate` field bridges unregistered organisations; surface map and build sequence |
