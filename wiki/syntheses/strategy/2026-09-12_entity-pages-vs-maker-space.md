...
| `ouch-cto` | Auto-prepared entity creation with 48 h veto (registry in a table, alias grouping proposed by the model, non-public ready state, notification) | when the trigger fires, after day 90 | deferred, validated 2026-09-12 |
