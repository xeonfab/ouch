...
- [Domain name shortlist](../syntheses/strategy/2026-09-13_domain-name-shortlist.md) — **domain**: buy `ouchdex.com` + `ouchdex.fr` (alternates `ouchdeck.com`, `sameouch.com`); `ouch.*` all taken; ≈ 8–11 €/year on .com
