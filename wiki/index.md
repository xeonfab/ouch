...
| [Maker pricing strategy — why pay when problems are public](syntheses/strategy/2026-09-12_maker-pricing-strategy.md) | "Voir gratuit, agir payant": public listing stays free as the maker funnel; Pro Maker (29 €/month, pause, no annual) sells reach to opt-ins via Ouch!, profiles, trend, claims, alerts; usage is episodic so the model bets on reactivation and a 9 €/month per-problem pipe, not annual retention; nothing built before the Cercle 2 signal |
