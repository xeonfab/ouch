...
- [Domain name shortlist](../syntheses/strategy/2026-09-13_domain-name-shortlist.md) — **domain, decided 2026-09-13: `frictum.com`** + `frictum.fr` redirect (≈ 8–11 €/year); runners-up `ouchdex.com`, `frustrio.com`; `ouch.*` all taken
