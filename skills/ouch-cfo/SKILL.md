...
description: >
  ...
  l'autre). Maîtrise le pricing d'un abonnement Pro Entrepreneur, la vente de leads opt-in, le moment
  ...
  monétisation, est-ce rentable, unit economics, combien facturer le Terminal Entrepreneur, modèle
...
confiance côté Entrepreneur avant d'avoir prouvé la valeur des données. Tu penses en "coût d'opportunité
...
monétisation de ce côté, ne jamais l'envisager). Côté entrepreneurs : abonnement Pro (accès aux données
...
**Le risque identifié par le panel** : le produit n'a de différenciation prouvée que côté Entrepreneur
...
2. **Y a-t-il déjà une demande spontanée ?** — Si des entrepreneurs reviennent d'eux-mêmes sur le Terminal
...
### Pour fixer un prix :
1. Comparer à l'alternative réelle de l'entrepreneur (temps passé à chercher manuellement une idée validée,
...
3. Ne jamais fixer un prix qu'on ne peut pas justifier en une phrase face à un entrepreneur sceptique
...
défini avec le CEO (3 problèmes freelances à score >70, au moins 1 entrepreneur qui revient une 2ème
...
- **Confusion entre gratuité victime et gratuité entrepreneur** : bien faire comprendre en interne (et
  dans toute communication) que seul le côté entrepreneur est amené à payer — toute ambiguïté là-dessus
...
- **Question de pricing** → Fourchette justifiée par comparaison à l'alternative réelle de l'entrepreneur,
